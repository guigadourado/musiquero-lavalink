module.exports = {
    ...
    clean: {
        command: {
            name: "clean",
            description: "Очистить все сообщения в канале, оставив только информацию о текущем треке"
        },
        noPermission: {
            title: "## ❌ Доступ Запрещен",
            message: "Вам нужно разрешение **Управление Сообщениями** для использования этой команды."
        },
        botNoPermission: {
            title: "## ❌ Отсутствует Разрешение Бота",
            message: "Боту нужно разрешение **Управление Сообщениями** для удаления сообщений."
        },
        success: {
            title: "## ✅ Канал Очищен",
            message: "Успешно удалено **{count}** сообщение(й) из этого канала.",
            note: "Все сообщения были удалены, кроме информации о текущем треке."
        },
        errors: {
            title: "## ❌ Ошибка",
            message: "Произошла ошибка при удалении сообщений.\\nПожалуйста, попробуйте позже.",
            fallback: "❌ Произошла ошибка при удалении сообщений."
        }
    },
    music: {
        autoplay: {
